        ...
        <div class="container mx-auto flex justify-between p-3 col-span-3">
            ...
            <nav class="grid grid-rows-2 grid-cols-3 col-span-2">
                ...
                <a href="{{ route('songs.index') }}"
                    class="text-white bg-gray-800 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-gray-800 dark:focus:ring-blue-800">Index</a>

                <a href="{{ route('songs.create') }}"
                    class="text-white bg-gray-800 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-gray-800 dark:focus:ring-blue-800">Create</a>
